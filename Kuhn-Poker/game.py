...
class Player(object):
    def __init__(self, is_human, hand, decision):
        ...
        self.hand = hand  # 手牌
        self.information_set = str(hand)  # 所处信息集，即手牌
...
class Game(object):
    ...
    def CFR_algorithm(self, h, pai1, pai2):
        ...
        :param h:  当前游戏状态，参与者1，2 的策略选择
        :param pai1:
        :param pai2:
        :return:
        """

        print(f'h:{h} , pai1:{pai1} ,pai2:{pai2} ')
        ...
        va = [0, 0]
        for a in action:  #对所有动作进行迭代 ，计算遗憾值
            # 玩家1
            if len(h) % 2 == 0:
